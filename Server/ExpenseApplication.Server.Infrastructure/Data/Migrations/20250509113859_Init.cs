        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastLoggedIn = table.Column<DateTime>(type: "datetime2(0)", maxLength: 36, nullable: true),
                    SerialNumber = table.Column<string>(type: "varchar(36)", maxLength: 36, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ManagerEmployees", x => new { x.ManagerId, x.EmployeeId });
                    table.ForeignKey(
                        name: "FK_ManagerEmployees_Users_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ManagerEmployees_Users_ManagerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    AccessTokenHash = table.Column<string>(type: "varchar(450)", maxLength: 450, nullable: true),
                    AccessTokenExpiresDateTime = table.Column<DateTime>(type: "datetime2(0)", nullable: false),
                    RefreshTokenIdHash = table.Column<string>(type: "varchar(450)", maxLength: 450, nullable: false),
                    RefreshTokenIdHashSource = table.Column<string>(type: "varchar(450)", maxLength: 450, nullable: true),
                    RefreshTokenExpiresDateTime = table.Column<DateTime>(type: "datetime2(0)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActionDateTime = table.Column<DateTime>(type: "datetime2(0)", nullable: false),
                    Comments = table.Column<string>(type: "varchar(450)", maxLength: 450, nullable: true)
                },
                constraints: table =>
                {
